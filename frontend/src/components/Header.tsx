      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6">
          <a href="#" className="flex items-center gap-2 group">
            ...
            <span className="text-2xl font-extrabold tracking-tight bg-gradient-to-r from-gray-900 via-gray-900 to-[#C5A880] bg-clip-text text-transparent group-hover:opacity-95 font-jakarta">
        ...
        <div className="flex items-center gap-4">
          <nav className="hidden lg:flex items-center gap-6 text-sm font-semibold text-gray-700 mr-2">
            ...
            <a href="#marketplace" className="hover:text-coral transition-colors">Shop</a>
            <a
              href="#ai-stylist"
              className="hover:text-coral text-coral transition-colors flex items-center gap-1"
            >
              <span className="w-1.5 h-1.5 rounded-full bg-coral"></span>AI Pilot
            </a>
          </nav>
          ...
          >
            {adminMode ? <User className="w-5 h-5" /> : <LayoutDashboard className="w-5 h-5 group-hover:scale-110 transition-transform" />}
          </button>
