...
export const Viewer360Modal: React.FC<Viewer360ModalProps> = ({ product, onClose }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="w-full flex items-center justify-between pb-4 border-b border-panelBorder/60 mb-6">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-lg bg-lavender-deep/60 hover:bg-lavender-deep text-gray-500 hover:text-gray-900 transition-colors"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="w-full flex items-center justify-between mt-6 gap-4">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-white hover:bg-lavender-deep border border-panelBorder text-gray-500 hover:text-gray-900 transition-colors"
              title="Reset View"
            >
